import './finanUsDataHtml.scss';

const FinanUsDataHtml = ({ values, handleSetChanges, handleSubmit, handleIsFinanUsData }) => {

    return (
        <div className='finanUsDataHtml'>
                    ...
                    <div className='finDatCont'>
                        ...
                        <div className='btnCont'>
                            ...
                            <button className='btn btnB'
                                onClick={() => handleIsFinanUsData(values.userId)}
                            >Cerrar</button>
                        </div>
                    </div>
...
export default FinanUsDataHtml;